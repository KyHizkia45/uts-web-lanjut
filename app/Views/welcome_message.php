...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Selamat Datang Di Website Ricky Hizkia </h1>

        <h2>Ini digunakan untuk menunjukan kompetensi saya dalam menggunakan framework HMVC dalam penggembangan aplikasi web serta menggelola source code menggunakan sistem control versi GIT </h2>
